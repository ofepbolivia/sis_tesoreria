...
class MODTsLibroBancosExtracto extends MODbase{
    ...
    function listarTsLibroBancosExtracto(){
        ...
        $this->procedimiento='tes.ft_ts_libro_bancos_extracto_sel';
        $this->transaccion='TES_LBANEX_SEL';
    ...
    function reporteLibroBancosExtracto(){
        //Definicion de variables para ejecucion del procedimientp
        $this->procedimiento='tes.ft_ts_libro_bancos_extracto_sel';
        $this->transaccion='TES_RELIBAEX_SEL';
        $this->tipo_procedimiento='SEL';//tipo de transaccion
    ...
    function insertarTsLibroBancosExtracto(){
        ...
        $this->procedimiento='tes.ft_ts_libro_bancos_extracto_ime';
        $this->transaccion='TES_LBANEX_INS';
