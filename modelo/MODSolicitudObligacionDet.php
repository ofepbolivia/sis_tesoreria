...
class MODSolicitudObligacionDet extends MODbase{
    ...
    function listarSolicitudObligacionDet(){
        ...
        $this->procedimiento='tes.ft_solicitud_obligacion_det_sel';
        $this->transaccion='TES_SOOBDET_SEL';
    ...
    function insertarSolicitudObligacionDet(){
        ...
        $this->procedimiento='tes.ft_solicitud_obligacion_det_ime';
        $this->transaccion='TES_SOOBDET_INS';
    ...
    function modificarSolicitudObligacionDet(){
        //Definicion de variables para ejecucion del procedimiento
        $this->procedimiento='tes.ft_solicitud_obligacion_det_ime';
        $this->transaccion='TES_SOOBDET_MOD';
        $this->tipo_procedimiento='IME';
...
//		$this->transaccion='TES_SOOBDET_ELI';
        $this->tipo_procedimiento='IME';
