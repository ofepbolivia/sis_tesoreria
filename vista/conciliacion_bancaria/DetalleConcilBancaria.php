...
<script>
    Phx.vista.DetalleConcilBancaria = Ext.extend(Phx.gridInterfaz, {
        ...
        constructor: function (config) {
            ...
            this.addButton('btnRepNuevo', {
                text: 'Reporte Nuevo',
                iconCls: 'bpdf',
                disabled: true,
                handler: this.onBtnReporteNuevo,
                tooltip: 'Generar el nuevo reporte PDF'
            });
        ...
        preparaMenu: function (n) {
            ...
            this.getBoton('btnRepNuevo').enable();
        },
        liberaMenu: function () {
            ...
            this.getBoton('btnRepNuevo').disable();
        },
        onBtnReporteNuevo: function () {
            var data = this.maestro;

            if (!data || !data.id_conciliacion_bancaria) {
                Ext.Msg.alert('Información', 'Seleccione una conciliación primero.');
                return;
            }
            ...
            Ext.Ajax.request({
                url: '../../sis_tesoreria/control/ConciliacionBancaria/detalleConciliacionBancariaNuevo',
                params: {
                    id_conciliacion_bancaria: data.id_conciliacion_bancaria,
                    tipoReporte: 'pdf' // OBLIGATORIO para que se genere PDF
                },
