    ...
    Phx.vista.DetalleReporteConciliacion = Ext.extend(Phx.gridInterfaz, {
        constructor: function (config) {
            ...
            this.addButton('btnPDF', {
                text: 'Generar PDF',
                iconCls: 'bpdf', // Asegúrate de tener un icono 'bpdf'
                disabled: false,
                handler: this.generarPDF,
                scope: this
            });
        },
        ...
        generarPDF: function() {
            var idConciliacion = this.maestro.id_conciliacion_bancaria;

            if (!idConciliacion) {
                Ext.Msg.alert('Error', 'No se ha seleccionado ninguna conciliación.');
                return;
            }
            ...
            Ext.Ajax.request({
                url: '../../sis_tesoreria/control/ConciliacionBancaria/detalleConciliaRepoNuevo',
                params: {
                    id_conciliacion_bancaria: idConciliacion,
