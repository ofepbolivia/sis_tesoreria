...
/**
 *@package  BoA
 *@file     PlanPagoReqPVR.php.php
 *@author  (franklin.espinoza)
 *@date     20-01-2022 10:22:05
 *@description Archivo con la interfaz de usuario para plan pago PVR
 */
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
    Phx.vista.PlanPagoReqPVR = {
        ...
        constructor: function(config) {
            ...
            //fecha inicio, fin solicitante
            this.Atributos[this.getIndAtributo('fecha_costo_ini')].allowBlank=false;
            this.Atributos[this.getIndAtributo('fecha_costo_fin')].allowBlank=false;
            this.maestro=config.maestro;

            Phx.vista.PlanPagoReqPVR.superclass.constructor.call(this,config);
        ...
        onButtonNew:function(){
            ...
            if(data){
                ...
                if(  data.monto_ejecutar_total_mo*1
                    ...
                    Phx.vista.PlanPagoReqPVR.superclass.onButtonNew.call(this);
        ...
        onButtonEdit:function(){
            ...
            Phx.vista.PlanPagoReqPVR.superclass.onButtonEdit.call(this);
        ...
        successSave: function(resp) {
            ...
            Phx.vista.PlanPagoReqPVR.superclass.successSave.call(this,resp);


        },
        successDel:function(resp){
            Phx.CP.getPagina(this.idContenedorPadre).reload();
            Phx.vista.PlanPagoReqPVR.superclass.successDel.call(this,resp);
        },
        ...
        preparaMenu:function(n){
            ...
            Phx.vista.PlanPagoReqPVR.superclass.preparaMenu.call(this,n);
        ...
        liberaMenu: function(){
            var tb = Phx.vista.PlanPagoReqPVR.superclass.liberaMenu.call(this);
            if(tb){
