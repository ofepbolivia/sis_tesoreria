...
?>
<script>
    Phx.vista.ObligacionDetPVR=Ext.extend(Phx.gridInterfaz,{

            constructor:function(config){
                this.maestro=config.maestro;
                //llama al constructor de la clase padre
                Phx.vista.ObligacionDetPVR.superclass.constructor.call(this,config);
            ...
            Atributos:[
                ...
                },
                {
                    config: {
                        ...
                        msgTarget: 'side',
                        renderer:function(value, p, record){return String.format('{0}', record.data['rotulo']);}
                    },
            ...
            onButtonEdit:function(){
                ...
                Phx.vista.ObligacionDetPVR.superclass.onButtonEdit.call(this);
            ...
            onButtonNew:function(){
                Phx.vista.ObligacionDetPVR.superclass.onButtonNew.call(this);
                this.cmpMontoPagoMo.enable();
            ...
            preparaMenu:function(n){
                ...
                Phx.vista.ObligacionDetPVR.superclass.preparaMenu.call(this,n);
            ...
            liberaMenu: function() {
                Phx.vista.ObligacionDetPVR.superclass.liberaMenu.call(this);
                this.getBoton('btnProrrateo').enable();
