 ...
 * @date 07-07-2019 10:22:05
 * @description Archivo con la interfaz de usuario que permite
 *dar el visto a solicitudes de compra SIP
 *
 */
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
    Phx.vista.SolicitudSinImputacionPresupuestaria = {
        bedit: true,
        bnew: true,
        bsave: false,
        bdel: true,
        ...
        title: 'Pago Sin Imputación Presupuestaria)',
        nombreVista: 'solicitudSinImputacionPresupuestaria',
        ...
        constructor: function (config) {
            ...
            Phx.vista.SolicitudSinImputacionPresupuestaria.superclass.constructor.call(this, config);
        ...
        onButtonEdit: function () {
            ...
            Phx.vista.SolicitudSinImputacionPresupuestaria.superclass.onButtonEdit.call(this);
        ...
        onButtonNew: function () {
            ...
            var me = this;
            me.objSolForm = Phx.CP.loadWindows('../../../sis_tesoreria/vista/solicitud_pago/FormSinImputacionPresupuestaria.php',
                'Formulario de pagos especiales Sin Imputación Presupuestaria',
                {
                    modal: true,
                    width: '90%',
                    height: '90%'
                ...
                this.idContenedor,
                'FormSinImputacionPresupuestaria',
                {
                    config: [{
                        event: 'successsave',
