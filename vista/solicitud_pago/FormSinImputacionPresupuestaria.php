...
/**
 * @package pXP
 * @file    FormObligacionEspecial.php
 * @author  Maylee Perez Pastor
 * @date    07-07-2019Moneda
...
<script>
    Phx.vista.FormSinImputacionPresupuestaria = Ext.extend(Phx.frmInterfaz, {
        ...
        constructor: function (config) {
            ...
            Phx.vista.FormSinImputacionPresupuestaria.superclass.constructor.call(this, config);
            this.init();
            this.iniciarEventos();
        ...
        Atributos: [
            ...
            },
            {
                ...
                type: 'Field',
                valorInicial: 'pago_especial_spi',
                form: true
            },
            {
                //configuracion del componente
        ...
        onNew: function () {
            ...
            this.cmpTipoObligacion.setValue('pago_especial_spi');
        ...
        onSubmit: function (o) {
            ...
            if (this.evaluaRequistos()) {
                ...
                if (k > 0 && !this.editorDetail.isVisible()) {
                    Phx.vista.FormSinImputacionPresupuestaria.superclass.onSubmit.call(this, o, true);
                }
                else {
                    if (confirm("No tiene ningún concepto  para comprar. ¿Desea continuar?")) {

                        Phx.vista.FormSinImputacionPresupuestaria.superclass.onSubmit.call(this, o);
                    }
        ...
        loadCheckDocumentosSolWf: function (data) {
            ...
            Phx.CP.loadWindows('../../../sis_workflow/vista/documento_wf/DocumentoWf.php',
                'Documentos de la solicitud de compra',
                {
                    width: '90%',
                    height: 500
                },
