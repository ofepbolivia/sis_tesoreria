...
<script>
    Phx.vista.FormObligacionPagoUnico=Ext.extend(Phx.frmInterfaz,{
        ...
        constructor:function(config)
        {
            ...
            Phx.vista.FormObligacionPagoUnico.superclass.constructor.call(this,config);
            this.init();
            this.iniciarEventos();
        ...
        onNew: function(){
            ...
            this.cmpTipoObligacion.setValue('spd');
        ...
        onSubmit: function(o) {
            ...
            if(this.evaluaRequistos()){
                ...
                if( k > 0 &&  !this.editorDetail.isVisible()){
                    Phx.vista.FormObligacionPagoUnico.superclass.onSubmit.call(this,o,undefined, true);
                }
                else{
                    if(confirm("No tiene ningun concepto  para comprar. ¿Desea continuar?")){

                        Phx.vista.FormObligacionPagoUnico.superclass.onSubmit.call(this,o);
                    }
