...
<script>
    Phx.vista.ObligacionPagoVb = {
        ...
        gruposBarraTareas: [{
            name: 'pago_unico',
            title: '<H1 align="center"><i class="fa fa-paper-plane"></i> Pago excepcional</h1>',
            grupo: 0,
            height: 0
        },
            {
                name: 'pago_directo',
                title: '<H1 align="center"><i class="fa fa-paper-plane-o"></i> Pago Recurrentes</h1>',
                grupo: 1,
                height: 0
            },
            {
                name: 'otros',
                title: '<H1 align="center"><i class="fa fa-plus-circle"></i> Otros</h1>',
                grupo: 2,
                height: 0
            }],
