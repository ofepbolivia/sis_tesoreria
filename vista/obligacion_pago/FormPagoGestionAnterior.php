...
/**
 *@package pXP
 *@file    FormPagoGestionAnterior.php
 *@author  franklin.espinoza
 *@date    04/01/2018
 *@description Formulario para pagos de gestiones anteriores.
 */
header("content-type: text/javascript; charset=UTF-8");
?>

<script>
    Phx.vista.FormPagoGestionAnterior=Ext.extend(Phx.frmInterfaz,{
        ...
        constructor:function(config)
        {
            ...
            Phx.vista.FormPagoGestionAnterior.superclass.constructor.call(this,config);
            this.init();
            this.iniciarEventos();
        ...
        onNew: function(){
            ...
            this.cmpTipoObligacion.setValue('pga');
        ...
        onSubmit: function(o) {
            ...
            if(this.evaluaRequistos()){
                ...
                if( k > 0 &&  !this.editorDetail.isVisible()){
                    Phx.vista.FormPagoGestionAnterior.superclass.onSubmit.call(this,o,undefined, true);
                }
                else{
                    if(confirm("No tiene ningun concepto  para comprar. ¿Desea continuar?")){

                        Phx.vista.FormPagoGestionAnterior.superclass.onSubmit.call(this,o);
                    }
