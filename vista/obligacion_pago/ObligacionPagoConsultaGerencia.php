 ...
 *@date 28-01-2020 10:22:05
 *@description Archivo con la interfaz permite consultar procesos segun la gerencia
 *
 */
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
    Phx.vista.ObligacionPagoConsultaGerencia = {
        bedit:false,
        bnew:false,
        bsave:false,
        bdel:false,
        ...
        nombreVista: 'ObligacionPagoConsultaGerencia',
        /*
        ...
        constructor: function(config) {
            ...
            Phx.vista.ObligacionPagoConsultaGerencia.superclass.constructor.call(this,config);
