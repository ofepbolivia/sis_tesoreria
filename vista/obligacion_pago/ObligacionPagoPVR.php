...
/**
 * @package pXP
 * @file    ObligacionPagoPVR.php
 * @author  franklin.espinoza
 * @date    01-11-2021 16:01:32
...
<script>
    Phx.vista.ObligacionPagoPVR = Ext.extend(Phx.gridInterfaz, {
        fheight: '90%',
        fwidth: '70%',
        ...
        constructor: function (config) {
            ...
            Phx.vista.ObligacionPagoPVR.superclass.constructor.call(this, config);
            this.init();
            ...
            this.store.baseParams.pes_estado = 'pago_pvr';
        ...
        generarPlanPago : function(){
            var rec = this.getSelectedData();
            Phx.CP.loadingShow();
            Ext.Ajax.request({
                url: '../../sis_tesoreria/control/ObligacionPago/generarPlanPagoPVR',
                params: {
                    id_obligacion_pago: rec.id_obligacion_pago,
                    operacion: 'generar'
                },
        ...
        tabsouth: [
            {
                url: '../../../sis_tesoreria/vista/obligacion_det/ObligacionDetPVR.php',
                title: 'Detalle',
                height: '50%',
        ...
        onButtonNew:function(){
            ...
            var me = this;
            me.objSolForm = Phx.CP.loadWindows('../../../sis_tesoreria/vista/obligacion_pago/FormObligacionPVR.php',
        ...
        successDocumento: function (resp) {
            ...
            Phx.vista.ObligacionPagoPVR.superclass.successDel.call(this, resp);

        },

        failureDocumento: function (resp) {
            Phx.CP.loadingHide();
            Phx.vista.ObligacionPagoPVR.superclass.conexionFailure.call(this, resp);
