...
/**
 * @package pXP
 * @file gen-ObligacionPagoPOCSol.php
...
?>
<script>
    Phx.vista.ObligacionPagoPOCSol = {
        require: '../../../sis_tesoreria/vista/obligacion_pago/ObligacionPagoPOC.php',
        requireclase: 'Phx.vista.ObligacionPagoPOC',
        title: 'Obligacion de Pago POC',
        nombreVista: 'obligacionPagoPOC',
        ...
        constructor: function (config) {
            ...
            Phx.vista.ObligacionPagoPOCSol.superclass.constructor.call(this, config);
        ...
        tabsouth: [
            ...
            },
            {
                ...
                url: '../../../sis_tesoreria/vista/plan_pago/PlanPagoPOCRegIni.php',
                title: 'Plan de Pagos (Reg. Adq.)',
                height: '50%',
                cls: 'PlanPagoPOCRegIni'
            }
        ...
        onButtonEdit: function () {
            ...
            Phx.vista.ObligacionPagoPOCSol.superclass.onButtonEdit.call(this);
            ...
            if (data.tipo_obligacion == 'pago_poc') {
        ...
        onButtonNew: function () {
            ...
            Phx.vista.ObligacionPagoPOCSol.superclass.onButtonNew.call(this);
            ...
            this.cmpTipoObligacion.setValue('pago_poc');
