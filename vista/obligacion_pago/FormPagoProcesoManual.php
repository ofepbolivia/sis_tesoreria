...
/**
 *@package pXP
 *@file    FormPagoProcesoManual.php
 *@author  franklin.espinoza
 *@date    29/01/2018
 *@description Formulario para pagos de procesos manuales.
 */
header("content-type: text/javascript; charset=UTF-8");
?>

<script>
    Phx.vista.FormPagoProcesoManual=Ext.extend(Phx.frmInterfaz,{
        ...
        constructor:function(config)
        {
            ...
            Phx.vista.FormPagoProcesoManual.superclass.constructor.call(this,config);
            this.init();
            this.iniciarEventos();
        ...
        onNew: function(){
            ...
            this.cmpTipoObligacion.setValue('ppm');
        ...
        onSubmit: function(o) {
            ...
            if(this.evaluaRequistos()){
                ...
                if( k > 0 &&  !this.editorDetail.isVisible()){
                    Phx.vista.FormPagoProcesoManual.superclass.onSubmit.call(this,o,undefined, true);
                }
                else{
                    if(confirm("No tiene ningun concepto  para comprar. ¿Desea continuar?")){

                        Phx.vista.FormPagoProcesoManual.superclass.onSubmit.call(this,o);
                    }
