...
?>
<script>
    Phx.vista.ObligacionPagoPOC = Ext.extend(Phx.gridInterfaz, {
        fheight: '90%',
        fwidth: '70%',
        ...
        constructor: function (config) {
            ...
            Phx.vista.ObligacionPagoPOC.superclass.constructor.call(this, config);
            this.init();
            ...
            this.addButton('btnObs', {
                text: 'Relacionar Proceso',
                iconCls: 'blist',
                disabled: true,
                handler: this.relacionarProceso,
                tooltip: '<b>Relacionar Proceso</b><br/><b>Relacionar procesos PCP</b>'
            });
        ...
        Atributos: [
...

            {
                config: {
                    ...
                    renderer: function (value, p, record) {
                        var dato = '';
                        dato = (dato == '' && value == 'pago_poc') ? 'Pago POC' : dato;
        ...
        iniciarEventos: function () {
            ...
            this.cmpTipoObligacion.on('select', function (c, rec, ind) {
                ...
                if (n == 'adquisiciones' || n == 'pago_directo'|| n == 'pago_poc') {
        ...
        preparaMenu: function (n) {
            ...
            Phx.vista.ObligacionPagoPOC.superclass.preparaMenu.call(this, n);
        ...
        liberaMenu: function () {
            var tb = Phx.vista.ObligacionPagoPOC.superclass.liberaMenu.call(this);
            if (tb) {
                this.getBoton('fin_registro').disable();
                this.getBoton('ant_estado').disable();
                this.getBoton('reporte_com_ejec_pag').disable();
        ...
        successDocumento: function (resp) {
            ...
            Phx.vista.ObligacionPagoPOC.superclass.successDel.call(this, resp);

        },

        failureDocumento: function (resp) {
            Phx.CP.loadingHide();
            Phx.vista.ObligacionPagoPOC.superclass.conexionFailure.call(this, resp);
        ...
        relacionarProceso: function () {
            var rec = this.sm.getSelected();
console.log('llegarelacionar', rec.data.id_proceso_wf )
            var data = {
                id_proceso_wf: rec.data.id_proceso_wf /*,
                id_estado_wf: rec.data.id_estado_wf,*/
                //num_tramite: rec.data.num_tramite
            }
            Phx.CP.loadWindows('../../../sis_tesoreria/vista/obligacion_pago/ObligacionPagoPOCRelacion.php',
                'Relacionar Proceso',
                {
                    width: '80%',
                    height: '70%'
