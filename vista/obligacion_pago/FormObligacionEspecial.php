...
<script>
    Phx.vista.FormObligacionEspecial = Ext.extend(Phx.frmInterfaz, {
        ...
        constructor: function (config) {
            ...
            Phx.vista.FormObligacionEspecial.superclass.constructor.call(this, config);
            this.init();
            this.iniciarEventos();
        ...
        iniciarEventosDetalle: function () {
            ...
            //may,  control para orden de trabajo
        ...
        onSubmit: function (o) {
            ...
            if (this.evaluaRequistos()) {
                ...
                if (k > 0 && !this.editorDetail.isVisible()) {
                    Phx.vista.FormObligacionEspecial.superclass.onSubmit.call(this, o, true);
                }
                else {
                    if (confirm("No tiene ningun concepto  para comprar. ¿Desea continuar?")) {

                        Phx.vista.FormObligacionEspecial.superclass.onSubmit.call(this, o);
                    }
