...
<script>
    Phx.vista.ProcesoCajaVbConta = {
        ...
        gruposBarraTareas: [{
            name: 'no_contabilizados',
            title: '<H1 align="center"><i class="fa fa-thumbs-o-down"></i> No Contabilizados</h1>',
            grupo: 0,
            height: 0
        },
            {
                name: 'contabilizados',
                title: '<H1 align="center"><i class="fa fa-thumbs-o-up"></i> Contabilizados</h1>',
                grupo: 1,
                height: 0
            }],
