...
?>
<script>
Phx.vista.EvoluPresupDet=Ext.extend(Phx.gridInterfaz,{
        nombreVista: 'comprometido',
        constructor:function(config){
            this.maestro=config.maestro;
            //llama al constructor de la clase padre
            Phx.vista.EvoluPresupDet.superclass.constructor.call(this,config);
            this.init();                                                
        },
        ...
        Atributos:[
            ...
            },
            {
                config:{
                    ...
                    fieldLabel: 'Comprometido Moneda Base',                                        
                    gwidth: 160,                    
                    renderer:(value, p, record) => {                         
                            return  String.format('<div style="text-align:right;"><b>{0}</b></div>',Ext.util.Format.number(value,'0,000.00'));                        
                    }
            ...
            },  
            {
                config:{
                    ...
                    gwidth: 80,                    
                    renderer:(value, p, record) => {     
                        var tc = record.data.comprometido > 0 ? record.data.comprometido_mb / record.data.comprometido: 0;
                        if (tc>0){
        ...
        fields: [
            ...
            {name:'comprometido_mb', type: 'numeric'},
            {name:'tipo_cambio_pj', type: 'numeric'}
        ],
        arrayDefaultColumHidden: ['comprometido_mb', 'tipo_cambio_pj'],
        sortInfo:{
