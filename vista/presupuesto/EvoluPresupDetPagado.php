...
?>
<script>
Phx.vista.EvoluPresupDetPagado=Ext.extend(Phx.gridInterfaz,{
        nombreVista: 'pagado',
        constructor:function(config){
            this.maestro=config.maestro;
            //llama al constructor de la clase padre
            Phx.vista.EvoluPresupDetPagado.superclass.constructor.call(this,config);
            this.init(); 
        ...
        Atributos:[
            ...
            },  
            {
                config:{
                    ...
                    gwidth: 80,                    
                    renderer:(value, p, record) => {     
                        var tc = record.data.pagado > 0 ? record.data.pagado_mb / record.data.pagado: 0;
                        if (tc>0){
        ...
        fields: [
            ...
            {name:'pagado_mb', type: 'numeric'},
            {name:'tipo_cambio_pj', type: 'numeric'}
        ],
        arrayDefaultColumHidden: ['pagado_mb', 'tipo_cambio_pj'],        
        sortInfo:{
