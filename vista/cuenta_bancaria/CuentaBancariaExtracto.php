 ...
 * @date 10-11-2016 10:22:05
 * @description Archivo con la interfaz de usuario que permite la ejecucion de todas las funcionalidades del sistema
 */
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
    Phx.vista.CuentaBancariaExtracto = {
        bedit: false,
        bnew: false,
        bsave: false,
        bdel: false,
        ...
        title: 'Cuenta Bancaria Extracto',
        nombreVista: 'cuentaBancariaExtracto',

        constructor: function (config) {
            this.maestro = config.maestro;

            this.initButtons = [this.cmbDepto];
            Phx.vista.CuentaBancariaExtracto.superclass.constructor.call(this, config);
            ...
            this.addButton('btnExtractoCsv',
                {
                    text: 'Subir Extracto',
                    iconCls: 'blist',
                    disabled: false,
                    handler: this.onButtonExtractoCsv,
                    tooltip: 'Subir extracto desde arhcivo CSV'
                }
            );
        ...
        preparaMenu: function (n) {
            ...
            var tb = this.tbar;
            Phx.vista.CuentaBancariaExtracto.superclass.preparaMenu.call(this, n);
            return tb
        },

        liberaMenu: function () {
            var tb = Phx.vista.CuentaBancariaExtracto.superclass.liberaMenu.call(this);
            return tb
        },
            ...
            if (NumSelect != 0) {
                Phx.CP.loadWindows('../../../sis_tesoreria/vista/transferencia_cuenta/FormTransferenciaCuenta.php',
                    'Transferencia Cuenta',
                    {
                        ...
                        data: rec.data,
                        id_depto_lb: this.store.baseParams.id_depto_lb
                    }, this.idContenedor, 'FormTransferenciaCuenta',
                    {
                        config: [{
                            event: 'beforesave',
        ...
        south:
            {
                //url:'../../../sis_bancos/vista/extracto/Extracto.php',
                url: '../../../sis_tesoreria/vista/extracto/Extracto.php',
                title: 'Detalle Extracto',
                height: '60%',
                cls: 'Extracto'
            },

        onButtonExtractoCsv: function () {
            var rec = this.sm.getSelected();
            Phx.CP.loadWindows('../../../sis_tesoreria/vista/ts_libro_bancos_extracto/ExtractoCSV.php',
                'Subir Extracto Bancario',
                {
                    modal: true,
                    width: 450,
                    height: 200
                }, rec.data, this.idContenedor, 'ConsumoCsv')
        },
    };
</script>
