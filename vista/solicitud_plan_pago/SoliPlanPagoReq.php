...
<script>
    Phx.vista.SoliPlanPagoReq = {
        ...
        constructor: function(config) {
            ...
            Phx.vista.SoliPlanPagoReq.superclass.constructor.call(this,config);
        ...
        onButtonNew:function(){
            ...
            if(data){
                ...
                if(  data.monto_ejecutar_total_mo*1
                    ...
                    Phx.vista.SoliPlanPagoReq.superclass.onButtonNew.call(this);
        ...
        onButtonEdit:function(){
            ...
            Phx.vista.SoliPlanPagoReq.superclass.onButtonEdit.call(this);
        ...
        successDel:function(resp){
            Phx.CP.getPagina(this.idContenedorPadre).reload();
            Phx.vista.SoliPlanPagoReq.superclass.successDel.call(this,resp);
        },
        ...
        preparaMenu:function(n){
            ...
            Phx.vista.SoliPlanPagoReq.superclass.preparaMenu.call(this,n);
        ...
        liberaMenu: function(){
            var tb = Phx.vista.SoliPlanPagoReq.superclass.liberaMenu.call(this);
            if(tb){
