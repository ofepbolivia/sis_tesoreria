 ...
 * @author  Maylee.perez
 * @date 27-07-2019 10:22:05
 * @description Archivo con la interfaz de usuario que permite
 *dar el visto a los procesos
 *
 */
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
    Phx.vista.SoliPlanPagoVbConta = {
        bedit: true,
        bnew: false,
        bsave: false,
        bdel: false,
        ...
        constructor: function (config) {
            ...
            Phx.vista.SoliPlanPagoVbConta.superclass.constructor.call(this, config);
        ...
        onButtonEdit: function () {
            ...
            Phx.vista.SoliPlanPagoVbConta.superclass.onButtonEdit.call(this);
        ...
        preparaMenu: function (n) {
            var data = this.getSelectedData();
            var tb = this.tbar;
            Phx.vista.SoliPlanPagoVbConta.superclass.preparaMenu.call(this, n);
        ...
        liberaMenu: function () {
            var tb = Phx.vista.SoliPlanPagoVbConta.superclass.liberaMenu.call(this);
