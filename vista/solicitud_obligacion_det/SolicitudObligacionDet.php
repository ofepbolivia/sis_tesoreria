...
?>
<script>
    Phx.vista.SolicitudObligacionDet=Ext.extend(Phx.gridInterfaz,{

            constructor:function(config){
                this.maestro=config.maestro;
                //llama al constructor de la clase padre
                Phx.vista.SolicitudObligacionDet.superclass.constructor.call(this,config);
            ...
            onButtonEdit:function(){
                ...
                Phx.vista.SolicitudObligacionDet.superclass.onButtonEdit.call(this);
            ...
            onButtonNew:function(){
                Phx.vista.SolicitudObligacionDet.superclass.onButtonNew.call(this);
                this.cmpMontoPagoMo.enable();
            ...
            iniciarEventos:function(){
                ...
                this.id_centro_costo=this.getComponente('id_obligacion_pago');
                ...
                //
                // this.Cmp.id_obligacion_pago.on(function(cmp,rec,ind){
                //      this.Cmp.id_centro_costo.reset();
                //      this.Cmp.id_centro_costo.store.baseParams.id_obligacion_pago = this.maestro.id_obligacion_pago;
                //      this.Cmp.id_centro_costo.modificado = true;
                // }, this);
                // this.Cmp.id_centro_costo.on('select',function(cmp,rec,ind){
                //     this.Cmp.id_obligacion_pago.reset();
                //     this.Cmp.id_obligacion_pago.store.baseParams.id_centro_costo = this.data.id_centro_costo;
            ...
            onReloadPage:function(m){
                ...
                this.Cmp.id_centro_costo.store.baseParams.id_obligacion_pago = this.Cmp.id_obligacion_pago;
                this.Cmp.id_centro_costo.modificado = true;
            ...
            preparaMenu:function(n){
                ...
                Phx.vista.SolicitudObligacionDet.superclass.preparaMenu.call(this,n);
            ...
            liberaMenu: function() {
                Phx.vista.SolicitudObligacionDet.superclass.liberaMenu.call(this);
                this.getBoton('btnProrrateo').enable();
