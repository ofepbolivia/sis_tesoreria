 ...
 *@author  
 *@date    
 *@description Archivo con la interfaz para generación de reporte conciliacion bancaria
 */
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
	Phx.vista.ConciliacionBancaria = Ext.extend(Phx.frmInterfaz, {
		...
		ActSave : '../../sis_tesoreria/control/TsLibroBancos/ConciliacionBancaria',
		timeout : 1500000,
		...
		/*onSubmit:function(o){
			if(this.cmpFormatoReporte.getValue()==2){
				...
				//Phx.vista.ConciliacionBancaria.superclass.onSubmit.call(this,o);				
			//}},
