      ...
      IF (p_id_plan_pago_fk is NULL  or v_registros_plan_pago.tipo = 'ant_aplicado' ) THEN 
            ...
            ------------------------------------------------------------------------------
             ...
             --si los pagos no son variables entonces puede hacerce un prorrateo automatico
                      ...
                      --se lista los centro de costo que se prorratean
                      FOR  v_registros in (
                                           select
...
ALTER FUNCTION tes.f_prorrateo_plan_pago (p_id_plan_pago integer, p_id_obligacion_pago integer, p_pago_variable varchar, p_monto_ejecutar_total_mo numeric, p_id_usuario integer, p_id_plan_pago_fk integer)
  OWNER TO postgres;