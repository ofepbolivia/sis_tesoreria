CREATE OR REPLACE FUNCTION tes.f_generar_deposito_cheque_trasn_propia (
...
/*
	Autor: BVP
    Fecha:
    Descripción: registro de deposito y cheque para cuenta propia
*/
DECLARE
...
BEGIN
     ...
     v_nombre_funcion:='tes.f_generar_deposito_cheque_trasn_propia';
    ...
    ELSE
       ...
       where cbte.id_int_comprobante = p_id_int_comprobante and tra.forma_pago = 'transferencia_propia';
		...
		if p_id_cuenta_bancaria is null then
        	v_id_cuenta_ban = v_datos_deposito_cheque.id_cuenta_bancaria;
        else
        ...
        v_resp = pxp.f_intermediario_ime(p_id_usuario::int4,NULL,NULL::varchar,'v58gc566o75102428i2usu08i4',13313,'172.17.45.202','99:99:99:99:99:99','tes.ft_ts_libro_bancos_ime','TES_LBAN_INS',NULL,'no',NULL,
        			array['filtro','ordenacion','dir_ordenacion','puntero','cantidad','_id_usuario_ai','_nombre_usuario_ai','id_cuenta_bancaria','id_depto','fecha','a_favor','nro_cheque','importe_deposito','nro_liquidacion','detalle','origen','observaciones','importe_cheque','id_libro_bancos_fk','nro_comprobante','comprobante_sigma','tipo','id_finalidad','id_int_comprobante','sistema_origen','fecha_pago'],
                    array[' 0 = 0 ','','','','','NULL','NULL',v_id_cuenta_ban::varchar,v_datos_deposito_cheque.id_depto_libro::varchar,''||current_date::varchar||'',v_datos_deposito_cheque.beneficiario::varchar,'',v_datos_deposito_cheque.importe_haber::varchar,'','INGRESO PARA PAGO A '||v_datos_deposito_cheque.glosa::varchar,v_datos_deposito_cheque.origen::varchar,v_datos_deposito_cheque.nro_tramite::varchar,'0','','','C31-'||p_c31,'deposito',p_id_finalidad::varchar,p_id_int_comprobante::varchar,v_sistema_origen::varchar, null::varchar],
        ...
        v_resp = pxp.f_intermediario_ime(p_id_usuario::int4,NULL,NULL::varchar,'v58gc566o75102428i2usu08i4',13313,'172.17.45.202','99:99:99:99:99:99','tes.ft_ts_libro_bancos_ime','TES_LBAN_INS',NULL,'no',NULL,
                    ...
                    array[' 0 = 0 ','','','','','NULL','NULL',v_id_cuenta_ban::varchar,v_datos_deposito_cheque.id_depto_libro::varchar,v_datos_deposito_cheque.beneficiario::varchar,'NULL','0','',v_datos_deposito_cheque.glosa::varchar,v_datos_deposito_cheque.origen::varchar,v_datos_deposito_cheque.nro_tramite::varchar,v_datos_deposito_cheque.importe_haber::varchar,v_id_deposito::varchar,'','C31-'||p_c31,'cheque',p_id_finalidad::varchar,v_sistema_origen::varchar,p_id_int_comprobante::varchar, null::varchar],
...
ALTER FUNCTION tes.f_generar_deposito_cheque_trasn_propia (p_id_usuario integer, p_id_int_comprobante integer, p_id_finalidad integer, p_id_cbte_endesis integer, p_c31 varchar, p_origen varchar, p_id_cuenta_bancaria integer)
  OWNER TO postgres;