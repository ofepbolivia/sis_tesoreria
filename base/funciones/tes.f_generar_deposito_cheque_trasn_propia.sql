    ...
    ELSE
       ...
       where cbte.id_int_comprobante = p_id_int_comprobante and tra.forma_pago = 'transferencia_propia';
        ...
        v_resp = pxp.f_intermediario_ime(p_id_usuario::int4,NULL,NULL::varchar,'v58gc566o75102428i2usu08i4',13313,'172.17.45.202','99:99:99:99:99:99','tes.ft_ts_libro_bancos_ime','TES_LBAN_INS',NULL,'no',NULL,
                    ...
                    array[' 0 = 0 ','','','','','NULL','NULL',v_id_cuenta_ban::varchar,v_datos_deposito_cheque.id_depto_libro::varchar,v_datos_deposito_cheque.beneficiario::varchar,'NULL','0','',v_datos_deposito_cheque.glosa::varchar,v_datos_deposito_cheque.origen::varchar,v_datos_deposito_cheque.nro_tramite::varchar,'0',v_id_deposito::varchar,'','C31-'||p_c31,'cheque',p_id_finalidad::varchar,v_sistema_origen::varchar,p_id_int_comprobante::varchar, null::varchar],
