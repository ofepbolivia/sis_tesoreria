...
ALTER FUNCTION tes.f_gestionar_presupuesto_doc_compra_venta (p_id_doc_compra_venta integer, p_id_proceso_caja integer, p_id_usuario integer, p_operacion varchar, p_conexion varchar)
  OWNER TO postgres;