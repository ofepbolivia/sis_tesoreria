CREATE OR REPLACE FUNCTION tes.f_gestionar_cuota_plan_pago_devengado (
...
BEGIN
	...
	v_nombre_funcion = 'tes.f_gestionar_cuota_plan_pago_devengado';
    ...
    --------------------------------------------------------
         ...
         /*      SELECT
           ...
           IF   (v_registros.tipo = 'devengado' and v_registros.temporal = 'no' ) THEN
                                ...
                                INSERT INTO
                                  ...
                                  VALUES (
                                   ...
                                   'pagado',
                                    ...
                                    v_registros.id_proveedor_cta_bancaria
                        ...
                        -- raise exception 'xxxxxx';
                          ...
                          /*v_verficacion2 = tes.f_generar_comprobante_devengado(
                                                          p_id_usuario,
                                                          p_id_usuario_ai,
                                                          p_usuario_ai,
                                                          v_id_plan_pago,
...
ALTER FUNCTION tes.f_gestionar_cuota_plan_pago_devengado (p_id_usuario integer, p_id_usuario_ai integer, p_usuario_ai varchar, p_id_int_comprobante integer, p_conexion varchar)
  OWNER TO postgres;
