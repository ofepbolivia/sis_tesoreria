CREATE OR REPLACE FUNCTION tes.f_gestionar_cuota_plan_pago_pvr (
...
BEGIN
	...
	v_nombre_funcion = 'tes.f_gestionar_cuota_plan_pago_pvr';
    ...
    --raise 'v_registros: %, %', v_registros.codigo_plantilla_comprobante, p_id_int_comprobante;
    ...
    --------------------------------------------------------
          ...
          -- obtiene el siguiente estado del flujo
	          ...
	          --raise 'va_id_tipo_estado[2] :%, %',va_id_tipo_estado[1], va_codigo_estado;

              --raise exception '[%] , {%}, [%] ',v_registros.id_proceso_wf,va_id_tipo_estado,va_codigo_estado;
           ...
           --------------------------------------------
           --RAISE 'tipo: %, %', v_registros.tipo, v_registros.temporal;
           ...
           IF   (v_registros.tipo = 'devengado_pagado' and v_registros.temporal = 'no' ) THEN
                          ...
                          --determinar el numero de cuota
                            ...
                            where tpp.codigo = 'pagado';-- and tpp.codigo_plantilla_comprobante = 'PAGDEVPVR';

                            --RAISE 'tipo cuota: %, %, %', v_registros.tipo, v_registros.temporal, v_codigo_proceso_llave_wf;
                            --RAISE 'tipo: %, %, [ % ], [ % ]', v_registros.tipo, v_registros.temporal, v_id_estado_actual, v_codigo_proceso_llave_wf;
                        ...
                        --actualiza el total de pagos registrados en el plan de pago padre
                         ...
                         inner join wf.tproceso_wf  pw on pw.id_tipo_proceso = te.id_tipo_proceso and pw.id_proceso_wf = v_id_proceso_wf
...
ALTER FUNCTION tes.f_gestionar_cuota_plan_pago_pvr (p_id_usuario integer, p_id_usuario_ai integer, p_usuario_ai varchar, p_id_int_comprobante integer, p_conexion varchar)
  OWNER TO postgres;