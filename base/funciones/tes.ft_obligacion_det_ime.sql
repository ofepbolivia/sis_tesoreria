	...
	***********************************/
	...
	if(p_transaccion='TES_OBDET_INS')then
        ...
        begin
          ...
          --pago_especial_spi-> para procesos SIP
          --spd-> para procesos directos sin con tratos
          IF v_tipo_obligacion = 'pago_especial' or v_tipo_obligacion = 'pago_especial_spi' or v_tipo_obligacion = 'spd' THEN
              v_relacion = 'PAGOES';
          ELSE
              v_relacion = 'CUECOMP';
          END IF;
...
ALTER FUNCTION tes.ft_obligacion_det_ime (p_administrador integer, p_id_usuario integer, p_tabla varchar, p_transaccion varchar)
  OWNER TO postgresCREATE OR REPLACE FUNCTION tes.ft_obligacion_det_ime (
  p_administrador integer,
  p_id_usuario integer,
  p_tabla varchar,
  p_transaccion varchar
