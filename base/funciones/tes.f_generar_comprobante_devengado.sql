CREATE OR REPLACE FUNCTION tes.f_generar_comprobante_devengado (
...
ALTER FUNCTION tes.f_generar_comprobante_devengado (p_id_usuario integer, p_id_usuario_ai integer, p_usuario_ai varchar, p_id_plan_pago integer, p_id_depto_conta integer, p_conexion varchar)
  OWNER TO postgres;
